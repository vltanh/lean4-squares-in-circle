...
Therefore (A22-env-NW)--(A22-env-ES) are now the **only missing statements**
needed to close R22-c.  There is no remaining three-variable optimization.
...
Therefore the **only remaining statement needed to close R22-c is the E/S
pair envelope (A22-env-ES)**.
