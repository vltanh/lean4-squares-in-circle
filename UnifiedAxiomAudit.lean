...
/- Run separately after elaborating the extension. This file is not evidence
that the declarations below have already been accepted by Lean. -/
#print axioms ThreeUnitSquaresInCircle.Unified.tangent_identity
